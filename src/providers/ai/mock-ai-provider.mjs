import { AIProvider, ProjectConfig, ModuleInfo, FileInfo, FunctionInfo, ProjectDocumentation, ModuleDocumentation, FileDocumentation, FunctionDocumentation } from '../../core/ai/ai-provider.js';
